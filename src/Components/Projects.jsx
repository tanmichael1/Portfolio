...
function Projects(){
    return <div className="projects">
        ...
        <p>This website is a project, using React</p>
        ...
        <p>I created a website using JavaScripts, CSS and HTML as practice for myself while doing
            ...
            It's very much a work in progress and won't replace my Wordpress site, but it's a way for 
            me to practice and progress with things on my own.</p>
