  ...
  return (
    <div id="projects" className="projects">
      <div style={{ width: "65vw", margin: "auto" }}>
        ...
        />
        <p>
          My second iteration of a quiz website, which will be available to
          everyone. It uses React, JavaScript, CSS and HTML, and makes use of
          Firebase’s database and hosting features. Registered users will be
          able to create, edit and delete their own quizzes. People will be able
          to take the publicly created quizzes, and add their names to the
        ...
        <p>
          ...
          and over the course of many years, I have now written over 850
